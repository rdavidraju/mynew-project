...
public class FileTemplateLinesResourceIntTest {
    ...
    private static final String DEFAULT_RECORD_START_ROW = "AAAAAAAAAA";
    private static final String UPDATED_RECORD_START_ROW = "BBBBBBBBBB";
    ...
    private  IntermediateTableRepository intermediateTableRepository;

    @Before
    public void setup() {
        MockitoAnnotations.initMocks(this);
        FileTemplateLinesResource fileTemplateLinesResource = new FileTemplateLinesResource(fileTemplatesRepository,fileTemplateLinesRepository, fileTemplateLinesSearchRepository,intermediateTableRepository);
    ...
    public static FileTemplateLines createEntity(EntityManager em) {
        FileTemplateLines fileTemplateLines = new FileTemplateLines()
        	...
        	.recordStartRow(DEFAULT_RECORD_START_ROW);
    ...
    public void createFileTemplateLines() throws Exception {
        ...
        assertThat(testFileTemplateLines.getRecordStartRow()).isEqualTo(DEFAULT_RECORD_START_ROW);
    ...
    public void getAllFileTemplateLines() throws Exception {
        ...
        .andExpect(jsonPath("$.[*].recordStartRow").value(hasItem(DEFAULT_RECORD_START_ROW.toString())));
    }
    ...
    public void getFileTemplateLines() throws Exception {
        ...
        restFileTemplateLinesMockMvc.perform(get("/api/file-template-lines/{id}", fileTemplateLines.getId()))
            ...
            .andExpect(jsonPath("$.recordStartRow").value(DEFAULT_RECORD_START_ROW.toString()));
    }
    ...
    public void updateFileTemplateLines() throws Exception {
        ...
        updatedFileTemplateLines
            ...
            .recordStartRow(UPDATED_RECORD_START_ROW);
        ...
        assertThat(testFileTemplateLines.getRecordStartRow()).isEqualTo(UPDATED_RECORD_START_ROW);
