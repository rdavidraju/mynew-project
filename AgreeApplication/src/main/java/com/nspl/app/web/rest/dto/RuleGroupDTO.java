...
public class RuleGroupDTO {
	...
	private String apprRuleGrpIdForDisplay;
	...
	private String conversionDateMeaning;
	...
	private Map<String,Integer> ruleGrpTypeAndCount;
	...
	public boolean isAdhocRuleCreation() {
	...
	public String getApprRuleGrpIdForDisplay() {
		return apprRuleGrpIdForDisplay;
	}
	public void setApprRuleGrpIdForDisplay(String apprRuleGrpIdForDisplay) {
		this.apprRuleGrpIdForDisplay = apprRuleGrpIdForDisplay;
	}
	...
	public String getFxRateName() {
		return fxRateName;
	}
	public void setFxRateName(String fxRateName) {
		this.fxRateName = fxRateName;
	}
	...
	public String getConversionDateMeaning() {
		return conversionDateMeaning;
	}
	public void setConversionDateMeaning(String conversionDateMeaning) {
		this.conversionDateMeaning = conversionDateMeaning;
	}
	...
	public String getCoaMeaning() {
		return coaMeaning;
	}
	public void setCoaMeaning(String coaMeaning) {
		this.coaMeaning = coaMeaning;
	}
	...
	public Map<String, Integer> getRuleGrpTypeAndCount() {
		return ruleGrpTypeAndCount;
	}
	public void setRuleGrpTypeAndCount(Map<String, Integer> ruleGrpTypeAndCount) {
		this.ruleGrpTypeAndCount = ruleGrpTypeAndCount;
	}
