...
public class DataViewColmnDTO {
	...
	public String toString() {
		return "DataViewColmnDTO [id=" + id + ", dataViewId=" + dataViewId
				...
				+ ", colName=" + colName + ", columnEdit=" + columnEdit
				+ ", operator=" + operator + ", colValue=" + colValue
				+ ", formula=" + formula + ", formulaAlias=" + formulaAlias
				+ ", sourceName=" + sourceName + ", qualifier=" + qualifier
				+ ", groupBy=" + groupBy + "]";
	}
