...
public class RuleConditionsResourceIntTest {
    ...
    private static final Boolean DEFAULT_S_RECON_AMOUNT_MATCH = false;
    private static final Boolean UPDATED_S_RECON_AMOUNT_MATCH = true;

    private static final Boolean DEFAULT_T_RECON_AMOUNT_MATCH = false;
    private static final Boolean UPDATED_T_RECON_AMOUNT_MATCH = true;
    ...
    public static RuleConditions createEntity(EntityManager em) {
        RuleConditions ruleConditions = new RuleConditions()
            ...
            .sReconAmountMatch(DEFAULT_S_RECON_AMOUNT_MATCH)
            .tReconAmountMatch(DEFAULT_T_RECON_AMOUNT_MATCH);
    ...
    public void createRuleConditions() throws Exception {
        ...
        assertThat(testRuleConditions.issReconAmountMatch()).isEqualTo(DEFAULT_S_RECON_AMOUNT_MATCH);
        assertThat(testRuleConditions.istReconAmountMatch()).isEqualTo(DEFAULT_T_RECON_AMOUNT_MATCH);
    ...
    public void getAllRuleConditions() throws Exception {
        ...
        restRuleConditionsMockMvc.perform(get("/api/rule-conditions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sReconAmountMatch").value(hasItem(DEFAULT_S_RECON_AMOUNT_MATCH.booleanValue())))
            .andExpect(jsonPath("$.[*].tReconAmountMatch").value(hasItem(DEFAULT_T_RECON_AMOUNT_MATCH.booleanValue())));
    }
    ...
    public void getRuleConditions() throws Exception {
        ...
        restRuleConditionsMockMvc.perform(get("/api/rule-conditions/{id}", ruleConditions.getId()))
            ...
            .andExpect(jsonPath("$.sReconAmountMatch").value(DEFAULT_S_RECON_AMOUNT_MATCH.booleanValue()))
            .andExpect(jsonPath("$.tReconAmountMatch").value(DEFAULT_T_RECON_AMOUNT_MATCH.booleanValue()));
    }
    ...
    public void updateRuleConditions() throws Exception {
        ...
        updatedRuleConditions
            ...
            .sReconAmountMatch(UPDATED_S_RECON_AMOUNT_MATCH)
            .tReconAmountMatch(UPDATED_T_RECON_AMOUNT_MATCH);
        ...
        assertThat(testRuleConditions.issReconAmountMatch()).isEqualTo(UPDATED_S_RECON_AMOUNT_MATCH);
        assertThat(testRuleConditions.istReconAmountMatch()).isEqualTo(UPDATED_T_RECON_AMOUNT_MATCH);
