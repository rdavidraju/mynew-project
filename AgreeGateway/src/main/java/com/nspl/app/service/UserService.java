...
public class UserService {
   ...
   /* 
    @Transactional(readOnly = true)    
    public Page<UserDTO> getAllUsersByTenantId(Pageable pageable,Long tenantId) {
        return userRepository.findAllByTenantIdOrderByCreatedDateDesc(tenantId,pageable);//.map(UserDTO::new);
    }*/
    
    /**
     * Retrieve the current logged in user based on login
     */
    @Transactional
    public User getCurrentUser() {
    	log.info("Currently Logged in User: "+SecurityUtils.getCurrentUserLogin());
    	User currentUser = userRepository.findOneByEmailAndActivatedIsTrue(SecurityUtils.getCurrentUserLogin()).get();
		return currentUser;
