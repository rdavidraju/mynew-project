...
export class RulesService {
   ...
   // private UserData = this.$sessionStorage.retrieve('userData');
    ...
    getRules(rulePurpose : any,ruleType : any){
        ...
        return this.http.get(this.fetchRulesByRulePurpose+'?rulePurpose='+rulePurpose+'&ruleType='+ruleType).map((res: Response) => {
            let jsonResponse = res.json();
            return jsonResponse;
        });
    }
    ...
    getAccountingRulesList(rulePurpose : any):Observable<any>{
        ...
        return this.http.get(this.accountingRuleListUrl+'?rulePurpose='+rulePurpose).map((res: Response) => {
            let jsonResponse = res.json();
            return jsonResponse;
        });
    }
    getApprovalRules(rulePurpose : any):Observable<any>{
        ...
        return this.http.get(this.fetchApprovalrules+'?rulePurpose='+rulePurpose).map((res: Response) => {
            let jsonResponse = res.json();
            return jsonResponse;
        });
    }
