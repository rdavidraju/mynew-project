...
@Component( {
    selector: 'ledger-definition-home',
    templateUrl: './ledger-definition-home.component.html'
} )
export class LedgerDefinitionHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === LedgerDefinitionBreadCrumbTitles.ledgerDefinitionNew) {
