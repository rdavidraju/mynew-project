...
@Component({
    selector: 'functionality-side-bar',
    templateUrl: './functionality-sidebar.component.html'
})
export class FunctionalitySideBarComponent implements OnInit {
    authorities: any[];
    isSaving: boolean;
     sourcebody:any;
    constructor(
        ...
        private functionalityModalService: FunctionalityService,
