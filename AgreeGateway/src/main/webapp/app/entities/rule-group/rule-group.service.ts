...
export class RuleGroupService {
    ...
    */
    ...
    filterViewsByReconRuleGroupAndAccountingDataSource(ruleGrpId: any, accDataSourceId): Observable<Response> {
        return this.http.get(this.filterViewsForAccountingRuleUrl + '?ruleGroupId=' + ruleGrpId + '&viewId=' + accDataSourceId).
            map((res: Response) => {
                 let jsonResponse: any;
            jsonResponse = res.json();
