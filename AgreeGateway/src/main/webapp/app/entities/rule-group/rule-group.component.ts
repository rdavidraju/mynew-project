...
export class RuleGroupComponent implements OnInit, OnDestroy {
    ...
    ruleGroupColumns = [
                    /*   { field: 'name', header: 'Group Name', width: '280px', align: 'left' },*/
                      { field: 'rulePurpose', header: 'Rule Purpose', width: '100px', align: 'center' },
                      { field: 'ruleCount', header: 'Rule Count', width: '100px', align: 'center' }
   ...
   /* loadContent(rulePurpose)
    {
     ...
     setRuleGroup()
     {
         ...
         if(this.sideBarData[this.selectedTab] && this.sideBarData[this.selectedTab].rulePurpose &&  this.sideBarData[this.selectedTab].rulePurpose.toLowerCase() != 'all' )
         this.ruleGroupService.routerRuleGroupType = this.sideBarData[this.selectedTab].rulePurpose.toUpperCase();
         else{
             if(this.sideBarData && this.sideBarData[1] && this.sideBarData[1].rulePurpose)
            this.ruleGroupService.routerRuleGroupType = this.sideBarData[1].rulePurpose.toUpperCase();
         }
     }
     ...
     if(event.field != 'ruleCount')
     {
       ...
       this.loadAll(this.sideBarData[this.selectedTab].rulePurpose );
     }
}
}
