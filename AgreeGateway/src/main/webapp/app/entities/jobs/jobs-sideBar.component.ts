    ...
    constructor(
        ...
        private commonService: CommonService,
          ...
          this.subscription = this.route.params.subscribe(params => {
              if (params['maintype']) {
                  this.frequencyType = params['maintype'];
              } else {
                this.frequencyType = 'SCHEDULED';
              }
          });
    }
...
//        })
    ...
    getSidebarData() {
        this.jobsService.sideBarJobLists(this.frequencyType).subscribe((res: any) => {
            this.jobsList = res;
    ...
    changeFilter(param, type) {
        ...
        let link = ['/jobs', { outlets: { 'content': [param] + '/' + [type] + '/' + [this.frequencyType] + '/schedulars-list' } }];
