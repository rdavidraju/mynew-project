...
currentAccount: any;
    ...
    calendarTableColumns = [
        ...
        { field: 'calendarType', header: 'Calendar Type', width: '200px', align: 'left' },
    ...
    constructor(
        ...
        this.columnOptions = [];
        for(let i = 0; i < this.calendarTableColumns.length; i++) {
            this.columnOptions.push({label: this.calendarTableColumns[i].header, value: this.calendarTableColumns[i]});
        }
...
/*         this.itemsPerPage = ITEMS_PER_PAGE;
    ...
    loadAll(){
        this.calendarService.getAllcalenderList(this.page, this.itemsPerPage, '').subscribe((res: any) => {
    ...
    onPaginateChange(event) {
        ...
        this.calendarService.getAllcalenderList(this.page+1, this.itemsPerPage, '').subscribe((res: any) => {
            this.calendar = res.json();
            this.calendarRecordsLength =+ res.headers.get('x-total-count');
        });
    }
...
/*     loadAll() {
    ...
    trackId(index: number, item: Calendar) {
        return item.id;
    }
