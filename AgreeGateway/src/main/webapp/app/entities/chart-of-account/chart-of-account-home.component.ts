...
@Component( {
    selector: 'chart-of-account-home',
    templateUrl: './chart-of-account-home.component.html'
} )
export class ChartOfAccountHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === ChartOfAccountBreadCrumbTitles.chartOfAccountNew) {
