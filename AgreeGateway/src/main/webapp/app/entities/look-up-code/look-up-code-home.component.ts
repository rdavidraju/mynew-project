...
@Component( {
    selector: 'look-up-code-home',
    templateUrl: './look-up-code-home.component.html'
} )
export class LookupCodeHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === LookupCodesBreadCrumbTitles.lookUpCodeNew) {
