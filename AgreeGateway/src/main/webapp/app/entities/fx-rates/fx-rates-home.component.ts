...
@Component( {
    selector: 'fx-rates-home',
    templateUrl: './fx-rates-home.component.html'
} )
export class FxRatesHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === FxRatesBreadCrumbTitles.fxRatesNew) {
