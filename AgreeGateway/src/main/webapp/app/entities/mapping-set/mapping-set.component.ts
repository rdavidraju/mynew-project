...
mappingSetTableColumns = [
    ...
    { field: 'purpose', header: 'Purpose', width: '200px', align: 'left' }
    ...
    getAllMappingSets(){
        this.mappingSetService.getListMappingSetsByTenantIdWithPagination(this.page, this.itemsPerPage).subscribe((res: any) => {
