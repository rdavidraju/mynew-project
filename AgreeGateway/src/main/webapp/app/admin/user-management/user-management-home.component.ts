...
@Component( {
    selector: 'user-management-home',
    templateUrl: './user-management-home.component.html'
} )
export class UserMgmtHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === UserMgmtBreadCrumbTitles.userMgmtNew) {
