...
@Component( {
    selector: 'tenant-details-home',
    templateUrl: './tenant-details-home.component.html'
} )
export class TenantDetailsHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === TenantDetailsBreadCrumbTitles.tenantDetailsNew) {
