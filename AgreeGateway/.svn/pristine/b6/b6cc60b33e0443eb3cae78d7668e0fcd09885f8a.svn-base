...
import { Processes, ProcessesBreadCrumbTitles } from './processes.model';
...
export class ProcessHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === ProcessesBreadCrumbTitles.processNew) {
