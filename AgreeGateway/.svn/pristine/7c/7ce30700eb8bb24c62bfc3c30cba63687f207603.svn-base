...
@Component( {
    selector: 'approval-groups-home',
    templateUrl: './approval-groups-home.component.html'
} )
export class ApprovalGroupsHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === ApprovalGroupsBreadCrumbTitles.approvalGroupsNew) {
