...
public class RuleGroup implements Serializable {
    ...
    @Column(name = "activity_based")
    private Boolean activityBased;
    
    @Column(name = "cross_currency")
    ...
    public RuleGroup startDate(ZonedDateTime startDate) {
    ...
    public RuleGroup endDate(ZonedDateTime endDate) {
	...
	public String toString() {
		return "RuleGroup [id=" + id + ", tenantId=" + tenantId + ", name="
				...
				+ ", enabledFlag=" + enabledFlag + ", activityBased=" + activityBased 
				+ ", multiCurrency=" + multiCurrency + ", crossCurrency=" + crossCurrency 
				+ ", createdBy=" + createdBy
