...
/**
 * Performance test for the DataStaging entity.
 */
class DataStagingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DataStaging entity")
