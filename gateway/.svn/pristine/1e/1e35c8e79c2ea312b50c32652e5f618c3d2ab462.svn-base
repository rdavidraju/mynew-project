...
export class JhiMainComponent implements OnInit {
    ...
    constructor(
        ...
        $(window).scroll(function () {
            ...
            //console.log('this.scrollToTop ' + this.scrollToTop);
            let scrollOffSet = $("#mainDiv").offset();
            if (scrollOffSet != undefined) {
                ...
                let scrollPosition = scrollOffSet.top - $(window).scrollTop();
                if (scrollPosition < -56) {
                    $('.scrollToTopIcon').css('visibility', 'visible');
                } else {
                    $('.scrollToTopIcon').css('visibility', 'hidden');
                }
            }
        });
    }
    ...
    ngOnInit() {
        ...
        //For Footer
        // $(".page-content").css('min-height',(window.innerHeight - 82)+'px');
    ...
    scrollTop() {
        $('html, body').animate({
            scrollTop: $("#mainDiv").offset().top - 55
        }, 1500);
    }
