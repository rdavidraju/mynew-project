...
public class Functionality implements Serializable {
    ...
    @Column(name = "func_display_name")
    private String funcDisplayName;
    ...
    public String getFuncDisplayName() {
		return funcDisplayName;
	}

	public void setFuncDisplayName(String funcDisplayName) {
		this.funcDisplayName = funcDisplayName;
	}
    ...
    public String toString() {
        return "Functionality{" +
            ...
            ", funcDisplayName='" + getFuncDisplayName() + "'" +
