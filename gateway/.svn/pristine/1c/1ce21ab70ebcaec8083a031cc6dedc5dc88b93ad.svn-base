...
@Component( {
    selector: 'jhi-source-profiles-home',
    templateUrl: './source-profiles-home.component.html'
} )
export class SourceProfilesHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === SourceProfilesBreadCrumbTitles.sourceProfileNew || routeSnapshot.data.breadcrumb === SourceProfilesBreadCrumbTitles.sourceProfiles) {
