...
public class MailServiceIntTest {
    ...
    public void setup() {
        ...
        mailService = new MailService(jHipsterProperties, javaMailSender, messageSource, templateEngine, tenantDetailsRepository, env);
    }
    ...
    public void testSendEmailFromTemplate() throws Exception {
        ...
        user.setLangKey("en");
        mailService.sendEmailFromTemplate(user, "testEmail", "email.test.title",0);
        verify(javaMailSender).send((MimeMessage) messageCaptor.capture());
        MimeMessage message = (MimeMessage) messageCaptor.getValue();
    ...
    public void testSendActivationEmail() throws Exception {
        ...
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailService.sendActivationValidationEmail(user,0);
        verify(javaMailSender).send((MimeMessage) messageCaptor.capture());
        MimeMessage message = (MimeMessage) messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo("test@localhost");
    ...
    public void testSendPasswordResetMail() throws Exception {
        ...
        user.setLogin("john");
        user.setEmail("john.doe@example.com");
        mailService.sendPasswordResetMail(user,0);
        verify(javaMailSender).send((MimeMessage) messageCaptor.capture());
        MimeMessage message = (MimeMessage) messageCaptor.getValue();
        assertThat(message.getAllRecipients()[0].toString()).isEqualTo(user.getEmail());
        assertThat(message.getFrom()[0].toString()).isEqualTo("test@localhost");
