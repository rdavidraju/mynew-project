...
export class ProcessService {
    ...
    find(id: number): Observable<Process> {
    ...
    private convert(process: Process): Process {
        ...
        copy.startDate = this.dateUtils
            .convertLocalDateToServer(process.startDate);
        copy.endDate = this.dateUtils
            .convertLocalDateToServer(process.endDate);

        copy.creationDate = this.dateUtils.toDate(process.creationDate);

        copy.lastUpdatedDate = this.dateUtils.toDate(process.lastUpdatedDate);
        return copy;
    }
}
