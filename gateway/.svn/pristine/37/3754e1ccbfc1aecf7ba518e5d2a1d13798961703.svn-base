...
export class TemplateDetailsComponent implements OnInit, OnDestroy {
    ...
    journalsTableColumns = [
        ...
        { field: 'ruleGroupName', header: 'Accounting Process' },
        { field: 'viewDisplayName', header: 'Source' }/* ,
    ...
    constructor(
        ...
        this.pageSizeOptions = pageSizeOptionsList;
   ...
   /*  loadPage(page: number) {
    ...
    ngOnInit() {
        ...
        this.page = 0;
        this.request = this.templateDetailsService.journalsList(this.page+1,this.itemsPerPage).subscribe((res:any)=>{
