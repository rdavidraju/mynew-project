...
public class Roles implements Serializable {
    ...
    public Roles startDate(ZonedDateTime startDate) {
    ...
    public Roles endDate(ZonedDateTime endDate) {
	...
	public String toString() {
		return "Roles [id=" + id + ", tenantId=" + tenantId + ", roleName="
				+ roleName + ", roleCode=" + roleCode + ", roleDesc="
				+ roleDesc + ", startDate=" + startDate + ", endDate="
				+ endDate + ", activeInd=" + activeInd + ", createdBy="
