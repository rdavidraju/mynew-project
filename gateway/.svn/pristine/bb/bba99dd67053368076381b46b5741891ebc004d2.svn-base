...
@Component({
    selector: 'ledger-definition-side-bar',
    templateUrl: './ledger-definition-sidebar.component.html'
})
export class LedgerDefinitionSideBarComponent implements OnInit {
    authorities: any[];
    isSaving: boolean;
    sourcebody:any;
    constructor(
