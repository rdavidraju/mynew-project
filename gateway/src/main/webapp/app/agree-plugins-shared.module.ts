...
import { MaterialModule, MdTabsModule, MdNativeDateModule, MdDatepickerModule,MdSlideToggleModule,MdAutocompleteModule, NativeDateAdapter, MD_DATE_FORMATS, DateAdapter,MdDialogModule,MdProgressBarModule,MdExpansionPanel, MdMenu, MdList } from '@angular/material';
