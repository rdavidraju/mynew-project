...
@Component( {
    selector: 'functionality-home',
    templateUrl: './functionality-home.component.html'
} )
export class FunctionalityHomeComponent implements OnInit {
    ...
    constructor(
        ...
        private functionalityServiceModalService: FunctionalityService
    ) {
        this.isClose = true;    
    }
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === FunctionalityBreadCrumbTitles.functionalityNew) {
