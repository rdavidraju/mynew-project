...
export class TemplateDetailsService {
    ...
    private ruleGroupsByTenantIdUrl = 'agreeapplication/api/RuleGroupsWithMeaning';/* ruleGroupsByTenantId */
    ...
    getAccountingRulesGrpList(rulePurpose: any): Observable<any> {
        return this.http.get(this.ruleGroupsByTenantIdUrl + '?page=1&rulePurpose=' + rulePurpose).map((res: Response) => {
            const jsonResponse = res.json();
            return jsonResponse;
        });
    }
