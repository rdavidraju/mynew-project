...
@Component( {
    selector: 'jhi-data-management-wq-home',
    templateUrl: './data-management-wq-home.component.html',
    animations: [routerTransition]

} )
export class DataManagementWqHomeComponent implements OnInit {
    ...
    private getPageTitle( routeSnapshot: ActivatedRouteSnapshot ) {
        ...
        if ( routeSnapshot.data.breadcrumb === DataManagementWQBreadCrumbTitles.dataManagementHome ) {
            //this.closeGroupby();
